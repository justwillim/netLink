...
void
insert(std::string& dst, size_t pos, const char* src)
{
...
void
erase(std::string& str, size_t pos, size_t len)
{
...
void
replace(std::string& dst, size_t pos, size_t len, const char* src)
{
...
void
append(std::string& str, char32_t c)
{
  switch (byteSize(c))
  {
    case 1:
...
std::u32string
convertToUtf32(const std::string& str)
{
...
std::string
convertFromUtf32(const std::u32string& str)
{
  std::string result;
