...
protected:
  ...
  //! Returns the initial serializer position in bytes (negative value if there
  //! is a header)
  ...
  virtual std::streamsize serialize(int64_t&                    pos,
                                    std::basic_streambuf<char>* streamBuffer,
                                    std::streamsize             bytes) = 0;
  //! Deserializes bytes at the given deserializer position pos from
  //! streamBuffer
  virtual std::streamsize deserialize(int64_t&                    pos,
                                      std::basic_streambuf<char>* streamBuffer,
...
public:
  ...
  //! Returns the size in bytes this MsgPack::Element takes if completely
  //! serialized
